...
function emarking_get_pdf_activity($activity, $download = false, $sections = null) {
	...
	$usercontext=context_user::instance($activity->userid);
...
function emarking_create_activity_pdf($user_object, $activity, $topmargin = 40) {
	global $USER;
...
function emarking__activities_clean_html_to_print($html)
{
	...
	$html = preg_replace('/<p align="justify"><\/p>/', '', $html);
