...
use emarking\event\course_module_instance_list_viewed;
...
class emarking_scalelevels_form extends moodleform
{
    ...
    public function definition()
    {
        ...
        foreach ($scales as $scale) {
            ...
            if($prevdata = $DB->get_record("emarking_scale_levels", array(
            ...
            for ($i = 0; $i < count($levels); $i ++) {
                ...
                $mform->addElement('text', $elementname, $levels[$i] . ":<span class='scalelevels'>&nbsp;$prev&nbsp;(%)&nbsp;" . get_string('to') . "</span>", array(
                    'size' => '15'
                ));
