...
if ($action == "edit") {
    ...
    $editcommentform = new EditCommentForm(null, array(
...
if ($action == 'list') {
    ...
    foreach ($predefinedcomments as $predefinedcomment) {
        $deleteurl_comment = new moodle_url('', array(
            'action' => 'delete',
            'id' => $cm->id,
        ...
        $editurl_comment = new moodle_url('', array(
            'action' => 'edit',
            'id' => $cm->id,
            'commentid' => $predefinedcomment->id
        ));
        ...
        $creator_name = $DB->get_record('user', array(
        ...
        $table->data[] = array(
            ...
            $editaction_comment . $deleteaction_comment
        );
    }
