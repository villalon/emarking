...
$string['filters'] = 'Filters';
$string['days'] = 'Days';
$string['daysstrong'] = '<strong>Days</strong>';
$string['emarkingname'] = 'Emarking Name';
$string['emarkingnamestrong'] = '<strong>Emarking Name</strong>';
$string['dayssenttoprint'] = 'Sent to print';
$string['printeddays'] = 'Printed';
$string['digitalizeddays'] = 'Digitalized';
$string['daysincorrection'] = 'Grading';
$string['gradeddays'] = 'Gradeded';
$string['publisheddays'] = 'Published';
$string['daysinregrading'] = 'regrading';
$string['regradeddays'] = 'Regradeded';
$string['finalpublicationdays'] = 'Final publication';
