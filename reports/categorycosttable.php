...
$categorycosttable->head = array(
    get_string('category', 'emarking'),
    get_string('categorycost', 'emarking'),
    get_string('costcenter', 'emarking'),
    get_string('edit', 'emarking'));
$categorycosttable->data = emarking_get_category_cost_table_data($categoryid);
