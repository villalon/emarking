...
// If we got the link from the module, we get the course moduble object
...
if($cmid > 0) {
	$url = new moodle_url('/mod/emarking/print/deleteexam.php', array('id'=>$exam->id, 'cm'=>$cm->id));
	$continueurl = new moodle_url('/mod/emarking/print/deleteexam.php', array('id'=>$exam->id,'confirm'=>1,'cm'=>$cm->id));
	$cancelurl = new moodle_url('/mod/emarking/print/exams.php', array('id'=>$cm->id));
} else {
	$url = new moodle_url('/mod/emarking/print/deleteexam.php', array('id'=>$exam->id, 'course'=>$course->id));
	$continueurl = new moodle_url('/mod/emarking/print/deleteexam.php', array('id'=>$exam->id,'confirm'=>1,'course'=>$course->id));
	$cancelurl = new moodle_url('/mod/emarking/print/exams.php', array('course'=>$course->id));
}
